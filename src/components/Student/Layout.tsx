              ...
              <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div className="flex items-center flex-shrink-0 px-4">
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/workflow-logo-white0-mark-white-text.svg"
                    alt="Workflow"
                  />
                </div>
        ...
        {/* <div className="">
          <div className="">
            ...
            <div className="mt-4 text-center ">
              ...
              <div className="flex flex-shrink-0 p-4 bg-white">
        ...
        {/* <div className="">
          <div className="">
            ...
            <div className="mt-4 text-center ">
              ...
              <nav className="flex-1 px-2 mt-5 space-y-1 overflow-hidden bg-white">
                {navigation.map((item) => (
                  <Link
                    key={item.name}
                    to={item.href}
