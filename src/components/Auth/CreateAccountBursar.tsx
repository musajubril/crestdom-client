...
export default function CreateAccountBursar() {
  ...
  <div className="lg:w-2/5 mx-auto h-full items-center justify-center flex flex-col">
    ...
    <form>
      <div className="mb-5 ">
        ...
        <input type="text" className=" lg:h-11 lg:w-rectangle w-min_rectangle h-7 mx-auto border-green-500 border-2 placeholder-gray-400 lg:text-sm text-xs pl-4 rounded-lg" placeholder="Example@rocket.mail" id="email" />
      </div>
      <div className="mb-2 ">
        <div className=" mb-3">
          Password
        </div>
        <input type="password" className=" lg:h-11 lg:w-rectangle w-min_rectangle h-7 mx-auto border-gray-400 border-2 placeholder-gray-400 lg:text-sm text-xs pl-4 rounded-lg" placeholder="*******" id="password" />
      </div>
