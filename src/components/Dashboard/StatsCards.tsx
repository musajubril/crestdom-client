...
export default function StatsCards({data}) {
  ...
  const stats = [
    { href: `#`,id: 1, name: 'Total Rooms', stat: data?.rooms, icon: HomeIcon},
    { href: `#`,id: 2, name: 'Total Bookings', stat: data?.bookings, icon: ClipboardListIcon},
    { href: `#`,id: 3, name: 'Private Rooms', stat: data?.special, icon: HomeIcon},
    { href: `#`,id: 3, name: 'General Rooms', stat: data?.general, icon: HomeIcon},
    { href: `#`,id: 3, name: 'Students', stat: data?.student, icon: UserGroupIcon},
    { href: `#`,id: 3, name: 'Bursar', stat: data?.bursar_name, icon: UserIcon},
